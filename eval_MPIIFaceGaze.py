...
if __name__ == '__main__':
    ...
    data = MpiiFaceGazeMetaLoader(
                        ...
                        transforms=transforms, exclude=False)
    ...
    for epoch in range(1):
        ...
        for i, (b_s_im, b_s_lc, b_s_lb, b_q_im, b_q_lc, b_q_lb) in enumerate(meta_test_loader):
            ...
            model = torch.load(f"/home/janek/software/L2CS-Net/models/mpii_00/model_epoch549.pkl")
            ...
            # Prepare data
                ...
                if APPLY_BOOSTING:
                    pitch_boost = xg.XGBRegressor(objective ='reg:squarederror')
                    yaw_boost = xg.XGBRegressor(objective ='reg:squarederror')
