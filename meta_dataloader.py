...
class WETMetaLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for s in support_set:
            ...
            yaw = yaw * 180 / np.pi
            bins = np.array(range(-self._angles_range, self._angles_range,
                            self._bin_resolution))
...
if __name__ == '__main__':
    transforms = t.Compose([t.CenterCrop(25),
    ...
    data = WETMetaLoader(annotations="/home/jan/meta_dataset_normalized/annotations.txt",
                         ...
                         nshot_support=15, n_query=30)
    s_im, s_lc, s_lb, q_im, q_lc, q_lb = data[2]

    data_transforms = WETMetaLoader(annotations="/home/jan/meta_dataset_normalized/annotations.txt",
                                    root="/home/jan/meta_dataset_normalized",
                                    nshot_support=15, n_query=30,
                                    transforms=transforms)
    s_im, s_lc, s_lb, q_im, q_lc, q_lb = data_transforms[2]
    print("main")